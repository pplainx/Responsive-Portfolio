(function(window) {
	...
	-------------------*/
		function PageTransition() {
			...
			setTimeout(function() {
				$('.ms-body__title').addClass('is-visible');
			}, 1400);
			...
			function show_items() {
				...
				relativeOffset
					...
					.add({
				  		targets: '.ms-body__title-poster, .down-btns, .ms-body__image .box-overlay, .ms-body__links',
						easing: 'easeInOutQuad',
						opacity: [0, 1],
						duration: 400,
						offset: 800,
	...
	-------------------*/
		function ParallaxHero() {
			...
			//Hero with image box
			if ($.exists('.ms-body.ms-body__poster')) {
				...
				function add_freeze_cover() {
					$('.ms-body.ms-body__poster').removeClass('cover-closed');
				...
				function remove_freeze_cover() {
					...
					setTimeout(function() {
						$('.ms-body.ms-body__poster').addClass('cover-closed');
					}, 50);
				}
				// Trigger to click
